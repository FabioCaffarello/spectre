...
// in `engines/engine/tests/kafka_integration.rs` and the conformance
// `test_kafka_sink.py`.
...
// `engines/engine/tests/s3_integration.rs` and the conformance
// `test_s3_sink.py`.
...
// is exercised in `engines/engine/tests/webhook_integration.rs` and
